...
class GetUserTest(TestCase):
    ...
    def test_get_user_by_email(self):
        ...
        desired_user = User.objects.create(email='healblue@icloud.com')
        found_user = PasswordlessAuthenticationBackend().get_user('healblue@icloud.com')
        self.assertEqual(found_user, desired_user)

    def test_returns_None_if_no_user_with_that_email(self):
        self.assertIsNone(
            PasswordlessAuthenticationBackend().get_user('healblue@icloud.com')
        )
